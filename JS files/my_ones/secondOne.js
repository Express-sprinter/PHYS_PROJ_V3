...
loadMesh('/models/sphere.obj', 0.03, new THREE.Vector3(3, 0, 0));
loadMesh('/models/67p_low_res.obj', 0.01, new THREE.Vector3(1, 0, 0));console.log("Meshes in scene:", meshes);
